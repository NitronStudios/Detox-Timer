...
export default function ChatModal({ onClose }) {
  ...
  return (
    <div style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 2500, paddingTop: 'var(--safe-top, 0px)' }}>
      <div style={{ width: '100vw', height: '100%', display: 'flex', overflow: 'hidden' }}>
