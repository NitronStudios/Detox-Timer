    ...
    <>
      <nav className="navbar">
        ...
        <div className="navbar-right">
          ...
          <button className={`icon-btn${showDash ? ' active' : ''}`}
            onClick={() => { setShowDash(s => !s); setShowSettings(false); setShowLeaderboard(false); setShowChat(false); setShowManualLog(false); }} title="Dashboard">
          ...
          <button className={`icon-btn${showManualLog ? ' active' : ''}`}
            onClick={() => { setShowManualLog(s => !s); setShowDash(false); setShowSettings(false); setShowLeaderboard(false); setShowChat(false); }} title="Manual Entry">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <button className={`icon-btn${showSettings ? ' active' : ''}`}
            onClick={() => { setShowSettings(s => !s); setShowDash(false); setShowLeaderboard(false); setShowChat(false); setShowManualLog(false); }} title="Settings">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className={`side-menu ${isMobileMenuOpen ? 'open' : ''}`}>
        ...
        <div className="side-menu-links">
          <button className={showDash ? 'active' : ''} onClick={() => handleMenuClick(() => { setShowDash(true); setShowSettings(false); setShowLeaderboard(false); setShowChat(false); setShowManualLog(false); })}>
          ...
          <button className={showLeaderboard ? 'active' : ''} onClick={() => handleMenuClick(() => { setShowLeaderboard(true); setShowDash(false); setShowSettings(false); setShowChat(false); setShowManualLog(false); })}>
          ...
          <button className={showChat ? 'active' : ''} onClick={() => handleMenuClick(() => { setShowChat(true); setShowDash(false); setShowSettings(false); setShowLeaderboard(false); setShowManualLog(false); })} style={{ position: 'relative' }}>
          ...
          <button className={showSettings ? 'active' : ''} onClick={() => handleMenuClick(() => { setShowSettings(true); setShowDash(false); setShowLeaderboard(false); setShowChat(false); setShowManualLog(false); })}>
